namespace BoardMaster.Core.Rules.Chess
{
    ...
    /// <summary>
    /// 수가 계속 진행되는 유일한 거시 단계입니다. Go/War/GuryongTu와 구조가 동일합니다 — 같은
    /// GamePhaseManager가 네 번째로 다른 장르에서도 그대로 돌아간다는 걸 보여주는 지점입니다.
    /// </summary>
    public sealed class ChessMainPlayPhase : OntDyn.IGamePhase
    {
